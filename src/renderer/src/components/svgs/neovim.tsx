  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-1">
        <stop stopColor="#16B0ED" stop-opacity="0.800235524" offset="0%" />
        <stop stopColor="#0F59B2" stop-opacity="0.83700023" offset="100%" />
      </linearGradient>
      ...
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-3">
        <stop stopColor="#88C649" stop-opacity="0.8" offset="0%" />
        <stop stopColor="#439240" stop-opacity="0.84" offset="100%" />
      </linearGradient>
    </defs>
    <g
      id="Page-1"
